...
element = WebDriverWait(driver, 10, 4).until(EC.presence_of_element_located((By.ID, "TPL_username_1")))
...
element = WebDriverWait(driver, 10, 3).until(EC.presence_of_element_located((By.CLASS_NAME, "ci_receive")))
print element.text
element.click()
driver.quit()